...
class SidePanel extends React.Component<
  SplitPaneProps & WithStylesProps,
  SplitPaneState
> {
  static propTypes = {
  ...
  public render() {
    ...
    const buttonBackgroundColor = collapsed
    ...
    return (
      <div {...css(styles.splitPane)}>
        {rightSide && (
          <div {...css(styles.mainPanel, mainPanelColorStyle)}>{mainPane}</div>
        )}
        <div
          {...css(
            styles.sidePanel,
