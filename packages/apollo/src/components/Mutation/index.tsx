 ...
 */
export default class Mutation<Data = unknown, Vars = OperationVariables> extends React.Component<
  Props<Data, Vars>
> {
  static defaultProps = {
  ...
  render() {
    ...
    return <BaseMutation<Data, Vars> {...(props as unknown)}>{this.handleRender}</BaseMutation>;
  }
}
