...
A card with multiple blocks of content.
...
A card with a top featured image.
...
A card with a left featured image.
...
A card with a right featured image.
...
```jsx
import IconChevronRight from ':icons/interface/IconChevronRight';
import Card from '.';
import Content from './Content';
import Text from '../Text';
...
Card as a button with middle alignment.
