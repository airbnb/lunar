...
export function popoverDisplaysWhenAnElementIsHovered() {
  ...
  return (
    <div>
      <Tooltip content={content} popover>
        <Button>Hover Me</Button>
      </Tooltip>
      ...
      <div style={{ textAlign: 'center' }}>
        <Tooltip content="This Popover should most definitely be centered" width={21} popover>
          <Button>
            Hover Me too
            <br />
            please
...
export function popoverExpandsAndShrinksWithContent() {
  return (
    <div>
      <Tooltip content={withexpandMultiple()} popover>
        <Button>Hover Me</Button>
      </Tooltip>
      ...
      <Spacing top={10}>
        <div style={{ textAlign: 'right' }}>
          ...
          <Tooltip content={withexpandMultiple()} width={100} popover>
            <Button>Hover Me</Button>
          </Tooltip>
        </div>
      </Spacing>
